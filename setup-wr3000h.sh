...
# ── ШАГ 5: Фикс Tailscale + direct_domains (чтобы long-poll не обрывался) ────
step "5/5 Добавляю Tailscale в direct_domains Podkop + авторизация"
...
sleep 3
"
ok "Tailscale домены добавлены в direct_domains Podkop"
